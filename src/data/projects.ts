...
export const PROJECTS: Project[] = [
  {
    ...
    titleIt: false,
    tagline: "Real-time classroom platform — screen sharing, whiteboard, stream reactions, Electron desktop.",
    vibe: false,
  ...
  },
  {
    ...
    name: "Track Stock",
    titleIt: false,
    tagline: "An AI-assisted US equities monitor — live quotes, news digests, alerts.",
    vibe: true,
    tags: ["Next.js", "FastAPI", "Claude API", "yfinance", "Finnhub", "Alpha Vantage", "Telegram", "Recharts"],
    role: "Solo build",
    year: "2026 —",
    status: "Building",
    overview:
  ...
  },
  {
    ...
    titleIt: true,
    tagline: "Telegram × iCloud calendar — AI-driven daily planning, automated.",
    vibe: true,
  ...
  },
  {
    ...
    name: "Splitly",
    titleIt: true,
    tagline: "Help friends settle bills fast — three split modes, real-time math.",
    vibe: false,
    tags: ["React", "TypeScript", "Next.js", "FastAPI", "PostgreSQL", "Firebase Auth"],
  ...
  },
  {
    ...
    titleIt: true,
    tagline: "The chapter before engineering — product design, branding, TV drama graphics, and a BenQ collaboration.",
    vibe: false,
